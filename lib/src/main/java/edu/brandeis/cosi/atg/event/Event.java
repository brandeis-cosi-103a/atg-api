 ...
 *
 * The {@link edu.brandeis.cosi.atg.engine.Engine} will notify
 * {@link edu.brandeis.cosi.atg.event.GameObserver}s of events as they occur.
 * Events are intended to be informational - they can be printed to a console,
 * logged or saved, or used by {@link edu.brandeis.cosi.atg.player.Player
 * Players} to more finely track the progression of the game, if needed by their
 * strategy.
 */
